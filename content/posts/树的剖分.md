...
void modify(int x,int y,int val)
{
    while(node[x].top!=node[y].top)
    {
        ...
        update(1,1,n,node[node[x].top].dfn,node[x].dfn,val);
        x=node[node[x].top].fa;
    }

    if(node[x].depth>node[y].depth)swap(x,y);
    update(1,1,n,node[x].dfn,node[y].dfn,val);
}
...
int ask(int x,int y)
{
    ...
    while(node[x].top!=node[y].top)
    {
        ...
        ans+=query(1,1,n,node[node[x].top].dfn,node[x].dfn);
        ans%=mod;
        x=node[node[x].top].fa;
    }

    if(node[x].depth>node[y].depth)swap(x,y);
    ans+=query(1,1,n,node[x].dfn,node[y].dfn);
...
int main()
{
    ...
    while(m--)
    {
        ...
        {
            cin>>y;
            update(1,1,n,node[x].dfn,node[x].dfn+node[x].node_count-1,y);
        }
        else
        {
            cout<<query(1,1,n,node[x].dfn,node[x].dfn+node[x].node_count-1)<<'\n';
        }
    }
